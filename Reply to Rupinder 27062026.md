# Reply — response to your 27-June reconciliation

**To:** Rupinder
**From:** Apoorv
**Subject:** Re: Financial reconciliation — my response to your 27-June file

---

Roop,

Thanks for the updated file. I've gone through it line by line against my own records — my Axis statements (2018–2026), the BoB joint account, the ICICI and HDFC credit-card statements, the Oorvi account, and all 113 of my Tata Steel salary slips.
...
## 1. Category summary — my contribution vs yours (your 7 heads)

Same heads as your top sheet, with my side filled in from statements. My asset contributions are traced to source (₹43.24 lakh of the ₹51.14 lakh is hard-verified against actual transactions; the rest is from the HDFC/ICICI accounts I'm still pulling).

| Head | A (me) ₹ | R (you) ₹ |
|---|---:|---:|
| One DXP (property) | 34,91,824 | 37,87,989 |
| Sobha (now your asset) | 11,05,829 | 12,13,530 |
| Car Tiago (now my asset) | 66,000 | 6,58,224 |
| Car XUV 700¹ | 4,50,000 | 11,08,900 |
| Rent & utilities | 25,53,000 | 13,54,000 |
| Maid salaries | 0 | 18,49,000 |
| Oorvi's school | 0 | 5,18,000 |

¹ Your XUV figure is shown after removing the ₹9.91 lakh that traces to Oorvi's account (see §3).
...
## 2. What your file leaves off my side (this is where the ₹11.96 lakh comes from)

Your sheet credits me for property, EMIs and rent, but drops every other rupee I actually paid. Adding those back, verified:

| Item | Amount ₹ |
|---|---:|
| Common household — day-to-day I funded (Axis + cards) | 30,13,962 |
| Oorvi transfers routed through the account | 9,22,406 |
| Marital jewellery I paid for (now with you) | 3,32,306 |
| iPhone I gifted you (Jun 2021) | 1,25,000 |
| Family holidays — my true after-tax cost (Tata Steel perk) | 3,65,026 |
...
## 3. On "the ₹9 lakh was borrowed from Oorvi's account"

This is the opposite of what the account shows. Oorvi's account (Axis, *"OORVI GUPTA U/G APOORV GUPTA"* — a minor account I'm the guardian on) reads like this over its full life:

| Flow | ₹ |
|---|---:|
| Grandparent gifts in (my parents) | 10,14,500 |
| Put in by me | 2,88,590 |
| Put in by you | 77,900 |
| **Out to you** | **10,69,000** |
| Out to me | 3,94,918 |
| **Net that flowed to you** | **≈ 9,91,100** |
| Net that came to me | ≈ 1,06,328 |

So the money didn't get "borrowed by me and repaid" — on a net basis **₹9.91 lakh flowed out of Oorvi's account to you** (against ₹0.78 lakh you put in); I netted about ₹1 lakh. Most of it was my parents' gift money passed straight through within days of arriving. It also wasn't "safely parked in a demat, never touched" — it was withdrawn, and the demat/investment outflows from that account are tiny.

The upshot: this doesn't reduce my contribution — it **funds part of what your file counts as your own** (the XUV payment and mutual funds, from what I recall). That's why the XUV row in §1 is adjusted down by ₹9.91 lakh. Your bank and mutual-fund statements will close this out; happy to reconcile it together.

---

## 4. On the "double-counting" (~₹2 lakh)

Here you're partly right, and I'll concede it rather than argue:
...
| Head (yours) | R (you) ₹ | A (me) — comparable ₹ |
|---|---:|---:|
| Food delivery, dining & groceries | ~7,88,000 | ~5,10,000 |
| Amazon / online shopping / apparel | ~7,31,000 | ~9,00,000 |
...
My documented day-to-day plus personal spend is **~₹47 lakh vs your ₹37.34 lakh**. So this pool is **symmetric** — if anything heavier on me — and it nets to roughly zero in the gap. It does not add ₹37.34 lakh to your side. (To be clear, this is the same everyday spending already reflected in the reconciliation above — I'm showing it here only to make the point that it runs both ways, not to claim it twice.)

Two things to flag on your sheet specifically:
- The **₹9.56 lakh "Splitwise – household expenses"** line is a single lump sitting *on top of* the itemised Amazon/Swiggy/travel/appliance rows for the same years (mostly 2018–19). A lump called "household" already contains those items — counting both double-counts that period.
- Both our day-to-day lists are, at this stage, **claims until backed by statements**. Mine at least ties to bank and card records. If you share your bank and card statements, we can validate both sides on the same footing — I'm genuinely fine doing that.
...
- **Sobha EMIs I funded** — ~₹6.28 lakh toward a home that's now solely yours (repayable at loan transfer).
- **Refundable security deposit** — ₹2.6 lakh I'm holding.
- **Marital-era investments** — ~₹46.99 lakh (mutual funds, equity, FD/PPF/NPS) your file doesn't mention at all.

And for context on the bigger picture: over FY19–FY26 my net take-home was **₹1.71 crore**, and it went into the three properties, the cars, rent, Oorvi and everyday life — I've retained almost nothing liquid. So the framing that I "owe" ₹37 lakh doesn't match where the money actually went.

I'd rather settle this fairly than argue over a one-sided number. Please share your bank and card statements so we can validate both day-to-day sides equally, and let's reconcile the four assets and the Oorvi flows properly. If you have receipts that move any of my classifications, send them over and I'll adjust.

This is an expense-cashflow reconciliation, not a settlement figure — the assets, income and maintenance sit with the lawyers.
